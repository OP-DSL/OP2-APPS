...
__global__ void op_cuda_airfoil_step7_1_save_soln(
...
void op_par_loop_airfoil_step7_1_save_soln(
    ...
    if (OP_diags > 2)
        printf(" kernel routine (direct): airfoil_step7_1_save_soln\n");
    ...
    op_cuda_airfoil_step7_1_save_soln<<<num_blocks, block_size>>>(
        (double *)arg0.data_d,
        (double *)arg1.data_d,
        set->size
    );
