...
__device__ inline void adt_calc(const double *x1, const double *x2, const double *x3,
  ...
  *adt += fabs(u * dy - v * dx) + c * sqrt(dx * dx + dy * dy);
  ...
  //*adt = (*adt) / cfl;
  *adt = (*adt) * (1.0f / op2_const_cfl_d);
}}


extern "C" __global__ __launch_bounds__(128)
void op2_k_airfoil_2_adt_calc_wrapper(
...
const char op2_k_airfoil_2_adt_calc_src[] = R"_op2_k(
namespace op2_m_airfoil_2_adt_calc {
...
void op_par_loop_airfoil_2_adt_calc(
    ...
    namespace kernel = op2_m_airfoil_2_adt_calc;
    ...
    op_profile_enter_kernel("airfoil_2_adt_calc", "c_CUDA", "Indirect (atomics)");
    op_profile_enter("Init");

    op_profile_enter("Kernel Info Setup");

    static bool first_invocation = true;
    static op::f2c::KernelInfo info("op2_k_airfoil_2_adt_calc_wrapper",
                                    (void *)op2_k_airfoil_2_adt_calc_wrapper,
                                    op2_k_airfoil_2_adt_calc_src);
