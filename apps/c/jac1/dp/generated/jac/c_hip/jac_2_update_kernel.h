...
void op2_k_jac_2_update_wrapper(
...
const char op2_k_jac_2_update_src[] = R"_op2_k(
namespace op2_m_jac_2_update {
...
__global__
static void op2_k_jac_2_update_init_gbls(
    double *gbl4,
    double *gbl5,
    double *gbl5_ref,
    int stride
) {
    namespace kernel = op2_m_jac_2_update;
...
void op_par_loop_jac_2_update(
    ...
    op_profile_enter_kernel("jac_2_update", "c_CUDA", "Direct");
    op_profile_enter("Init");

    op_profile_enter("Kernel Info Setup");

    static bool first_invocation = true;
    static op::f2c::KernelInfo info("op2_k_jac_2_update_wrapper",
                                    (void *)op2_k_jac_2_update_wrapper,
                                    op2_k_jac_2_update_src);
    ...
    op2_k_jac_2_update_init_gbls<<<max_blocks, block_size>>>(
        (double *)arg4.data_d,
        (double *)arg5.data_d,
        gbl5_ref_d,
        stride_gbl
