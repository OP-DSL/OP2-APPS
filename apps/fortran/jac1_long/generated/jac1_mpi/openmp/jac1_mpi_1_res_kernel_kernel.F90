...
SUBROUTINE res_kernel_simd(A, u, du, beta)
  IMPLICIT NONE
  ...
  du = du + beta * A * u
END SUBROUTINE res_kernel_simd
...
subroutine res_kernel_wrapper2( &
    dat0, &
    dat1, &
    dat2, &
    map0, &
...
subroutine op2_k_jac1_mpi_1_res_kernel_m( &
    ...
    call op_profile_enter_kernel("jac1_mpi_1_res_kernel", "openmp", "Indirect")
