...
__device__ inline void res_calc(const float *x1, const float *x2, const float *q1,
...
void op2_k_airfoil_mpi_3_res_calc_wrapper(
...
const char op2_k_airfoil_mpi_3_res_calc_src[] = R"_op2_k(
namespace op2_m_airfoil_mpi_3_res_calc {
...
void op_par_loop_airfoil_mpi_3_res_calc(
    ...
    namespace kernel = op2_m_airfoil_mpi_3_res_calc;
    ...
    op_profile_enter_kernel("airfoil_mpi_3_res_calc", "c_CUDA", "Indirect (atomics)");
    op_profile_enter("Init");

    op_profile_enter("Kernel Info Setup");

    static bool first_invocation = true;
    static op::f2c::KernelInfo info("op2_k_airfoil_mpi_3_res_calc_wrapper",
                                    (void *)op2_k_airfoil_mpi_3_res_calc_wrapper,
                                    op2_k_airfoil_mpi_3_res_calc_src);
    ...
    block_limit = std::min(block_limit, getBlockLimit(args, n_args, block_size, "airfoil_mpi_3_res_calc"));
