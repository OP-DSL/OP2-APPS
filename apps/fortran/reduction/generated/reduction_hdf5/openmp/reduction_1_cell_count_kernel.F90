...
SUBROUTINE cell_count_simd(res, cell_count_result)
  IMPLICIT NONE
...
subroutine cell_count_wrapper2( &
    dat0, &
    gbl1, &
    start, &
    end &
...
subroutine op2_k_reduction_1_cell_count_m( &
    ...
    call op_profile_enter_kernel("reduction_1_cell_count", "openmp", "Direct")
