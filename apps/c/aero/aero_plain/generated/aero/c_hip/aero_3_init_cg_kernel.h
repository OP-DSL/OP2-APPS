namespace op2_m_aero_3_init_cg {
...
void op2_k_aero_3_init_cg_wrapper(
...
const char op2_k_aero_3_init_cg_src[] = R"_op2_k(
namespace op2_m_aero_3_init_cg {
...
__global__
static void op2_k_aero_3_init_cg_init_gbls(
    double *gbl1,
    int stride
) {
    namespace kernel = op2_m_aero_3_init_cg;
...
void op_par_loop_aero_3_init_cg(
    ...
    // op_timing2_enter_kernel("aero_3_init_cg", "c_CUDA", "Direct");
    // op_timing2_enter("Init");

    // op_timing2_enter("Kernel Info Setup");

    static bool first_invocation = true;
    static op::f2c::KernelInfo info("op2_k_aero_3_init_cg_wrapper",
                                    (void *)op2_k_aero_3_init_cg_wrapper,
                                    op2_k_aero_3_init_cg_src);

    auto [block_limit, block_size] = info.get_launch_config(nullptr, set->size);
    block_limit = std::min(block_limit, getBlockLimit(args, n_args, block_size, "aero_3_init_cg"));
    ...
    op2_k_aero_3_init_cg_init_gbls<<<max_blocks, block_size>>>(
        (double *)arg1.data_d,
        stride_gbl
    );
