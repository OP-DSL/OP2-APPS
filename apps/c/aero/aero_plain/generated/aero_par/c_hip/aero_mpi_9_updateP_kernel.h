...
void op2_k_aero_mpi_9_updateP_wrapper(
...
const char op2_k_aero_mpi_9_updateP_src[] = R"_op2_k(
namespace op2_m_aero_mpi_9_updateP {
...
void op_par_loop_aero_mpi_9_updateP(
    ...
    namespace kernel = op2_m_aero_mpi_9_updateP;
    ...
    // op_timing2_enter_kernel("aero_mpi_9_updateP", "c_CUDA", "Direct");
    // op_timing2_enter("Init");

    // op_timing2_enter("Kernel Info Setup");

    static bool first_invocation = true;
    static op::f2c::KernelInfo info("op2_k_aero_mpi_9_updateP_wrapper",
                                    (void *)op2_k_aero_mpi_9_updateP_wrapper,
                                    op2_k_aero_mpi_9_updateP_src);

    auto [block_limit, block_size] = info.get_launch_config(nullptr, set->size);
    block_limit = std::min(block_limit, getBlockLimit(args, n_args, block_size, "aero_mpi_9_updateP"));
