namespace op2_m_airfoil_step7_2_adt_calc {
...
void op2_k_airfoil_step7_2_adt_calc_wrapper(
    ...
    for (int i = thread_id + start; i < end; i += blockDim.x * gridDim.x) {
        ...
        op2_m_airfoil_step7_2_adt_calc::adt_calc(
...
const char op2_k_airfoil_step7_2_adt_calc_src[] = R"_op2_k(
namespace op2_m_airfoil_step7_2_adt_calc {
...
void op_par_loop_airfoil_step7_2_adt_calc(
    ...
    namespace kernel = op2_m_airfoil_step7_2_adt_calc;
    ...
    op_profile_enter_kernel("airfoil_step7_2_adt_calc", "c_CUDA", "Indirect (atomics)");
    op_profile_enter("Init");

    op_profile_enter("Kernel Info Setup");

    static bool first_invocation = true;
    static op::f2c::KernelInfo info("op2_k_airfoil_step7_2_adt_calc_wrapper",
                                    (void *)op2_k_airfoil_step7_2_adt_calc_wrapper,
                                    op2_k_airfoil_step7_2_adt_calc_src);
    ...
    block_limit = std::min(block_limit, getBlockLimit(args, n_args, block_size, "airfoil_step7_2_adt_calc"));
