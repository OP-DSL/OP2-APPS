...
extern "C" __global__ 
void op2_k_aero_mpi_5_dirichlet_wrapper(
...
const char op2_k_aero_mpi_5_dirichlet_src[] = R"_op2_k(
namespace op2_m_aero_mpi_5_dirichlet {
...
void op_par_loop_aero_mpi_5_dirichlet(
    ...
    namespace kernel = op2_m_aero_mpi_5_dirichlet;
    ...
    op_profile_enter_kernel("aero_mpi_5_dirichlet", "c_CUDA", "Indirect (atomics)");
    op_profile_enter("Init");

    op_profile_enter("Kernel Info Setup");

    static bool first_invocation = true;
    static op::f2c::KernelInfo info("op2_k_aero_mpi_5_dirichlet_wrapper",
                                    (void *)op2_k_aero_mpi_5_dirichlet_wrapper,
                                    op2_k_aero_mpi_5_dirichlet_src);
    ...
    block_limit = std::min(block_limit, getBlockLimit(args, n_args, block_size, "aero_mpi_5_dirichlet"));
