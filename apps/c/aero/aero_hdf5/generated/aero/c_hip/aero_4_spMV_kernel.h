...
void op2_k_aero_4_spMV_wrapper(
...
const char op2_k_aero_4_spMV_src[] = R"_op2_k(
namespace op2_m_aero_4_spMV {
...
void op_par_loop_aero_4_spMV(
    ...
    namespace kernel = op2_m_aero_4_spMV;
    ...
    // op_timing2_enter_kernel("aero_4_spMV", "c_CUDA", "Indirect (atomics)");
    // op_timing2_enter("Init");

    // op_timing2_enter("Kernel Info Setup");

    static bool first_invocation = true;
    static op::f2c::KernelInfo info("op2_k_aero_4_spMV_wrapper",
                                    (void *)op2_k_aero_4_spMV_wrapper,
                                    op2_k_aero_4_spMV_src);
    ...
    block_limit = std::min(block_limit, getBlockLimit(args, n_args, block_size, "aero_4_spMV"));
