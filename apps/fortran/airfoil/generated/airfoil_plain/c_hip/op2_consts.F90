...
module op2_consts
    ...
    real(8), bind(C) :: op2_const_gam
    real(8), bind(C) :: op2_const_gm1
    real(8), bind(C) :: op2_const_cfl
    real(8), bind(C) :: op2_const_eps
    real(8), bind(C) :: op2_const_mach
    real(8), bind(C) :: op2_const_alpha
    real(8), dimension(4), bind(C) :: op2_const_qinf
