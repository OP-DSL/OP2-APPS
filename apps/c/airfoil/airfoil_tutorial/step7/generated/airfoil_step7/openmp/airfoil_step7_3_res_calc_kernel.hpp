...
void airfoil_step7_3_res_calc_wrapper(
    ...
    for (; block + SIMD_LEN < end; block += SIMD_LEN) {
        alignas(SIMD_LEN * 8) double arg6_0_local[SIMD_LEN][4] = {0};
        alignas(SIMD_LEN * 8) double arg7_1_local[SIMD_LEN][4] = {0};
...
void op_par_loop_airfoil_step7_3_res_calc(
    ...
    for (int col = 0; col < plan->ncolors; ++col) {
        ...
        for (int block_idx = 0; block_idx < num_blocks; ++block_idx) {
            ...
            airfoil_step7_3_res_calc_wrapper(
                (double *)arg0.data,
                (double *)arg2.data,
                (double *)arg4.data,
                (double *)arg6.data,
