...
static __device__ void res_kernel(
    const double a,
    const double u,
    double& du,
    const double beta
...
void op2_k_jac1_mpi_1_res_kernel_m_wrapper(
    ...
    using namespace op2_m_jac1_mpi_1_res_kernel_m;
...
const char op2_k_jac1_mpi_1_res_kernel_m_src[] = R"_op2_k(
namespace op2_m_jac1_mpi_1_res_kernel_m {
...
extern "C" void op2_k_jac1_mpi_1_res_kernel_m_c(
    ...
    namespace kernel = op2_m_jac1_mpi_1_res_kernel_m;

    int n_args = 4;
    op_arg args[4];

    op_timing2_enter_kernel("jac1_mpi_1_res_kernel", "c_CUDA", "Indirect (atomics)");
    op_timing2_enter("Init");

    op_timing2_enter("Kernel Info Setup");

    static bool first_invocation = true;
    static op::f2c::KernelInfo info("op2_k_jac1_mpi_1_res_kernel_m_wrapper",
                                    (void *)op2_k_jac1_mpi_1_res_kernel_m_wrapper,
                                    op2_k_jac1_mpi_1_res_kernel_m_src);
    ...
    block_limit = std::min(block_limit, getBlockLimit(args, n_args, block_size, "jac1_mpi_1_res_kernel"));
