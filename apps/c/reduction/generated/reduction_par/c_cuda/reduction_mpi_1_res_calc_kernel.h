...
extern "C" __global__ 
void op2_k_reduction_mpi_1_res_calc_wrapper(
...
const char op2_k_reduction_mpi_1_res_calc_src[] = R"_op2_k(
namespace op2_m_reduction_mpi_1_res_calc {
...
__global__
static void op2_k_reduction_mpi_1_res_calc_init_gbls(
    int *gbl1,
    int stride
) {
    namespace kernel = op2_m_reduction_mpi_1_res_calc;
...
void op_par_loop_reduction_mpi_1_res_calc(
    ...
    op_profile_enter_kernel("reduction_mpi_1_res_calc", "c_CUDA", "Indirect (atomics)");
    op_profile_enter("Init");

    op_profile_enter("Kernel Info Setup");

    static bool first_invocation = true;
    static op::f2c::KernelInfo info("op2_k_reduction_mpi_1_res_calc_wrapper",
                                    (void *)op2_k_reduction_mpi_1_res_calc_wrapper,
                                    op2_k_reduction_mpi_1_res_calc_src);
    ...
    block_limit = std::min(block_limit, getBlockLimit(args, n_args, block_size, "reduction_mpi_1_res_calc"));
    ...
    op2_k_reduction_mpi_1_res_calc_init_gbls<<<max_blocks, block_size>>>(
        (int *)arg1.data_d,
        stride_gbl
    );
