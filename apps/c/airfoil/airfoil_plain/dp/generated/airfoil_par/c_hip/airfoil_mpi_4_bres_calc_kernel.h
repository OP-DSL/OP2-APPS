...
void op2_k_airfoil_mpi_4_bres_calc_wrapper(
...
const char op2_k_airfoil_mpi_4_bres_calc_src[] = R"_op2_k(
namespace op2_m_airfoil_mpi_4_bres_calc {
...
void op_par_loop_airfoil_mpi_4_bres_calc(
    ...
    namespace kernel = op2_m_airfoil_mpi_4_bres_calc;
    ...
    static op::f2c::KernelInfo info("op2_k_airfoil_mpi_4_bres_calc_wrapper",
                                    (void *)op2_k_airfoil_mpi_4_bres_calc_wrapper,
                                    op2_k_airfoil_mpi_4_bres_calc_src);
    ...
    block_limit = std::min(block_limit, getBlockLimit(args, n_args, block_size, "airfoil_mpi_4_bres_calc"));
