...
// #define OP_F2C_PARAMS OP_F2C_PARAMS_2097141866
// #define OP_F2C_PARAMS_DATA OP_F2C_PARAMS_2097141866_data
// INCTXT(OP_F2C_PARAMS, "op2_const_list_params.h");

#define OP_F2C_PRELUDE OP_F2C_PRELUDE_2097141866
#define OP_F2C_PRELUDE_DATA OP_F2C_PRELUDE_2097141866_data
...
#include "aero_mpi_1_res_calc_kernel.h"
#include "aero_mpi_2_dirichlet_kernel.h"
#include "aero_mpi_3_init_cg_kernel.h"
#include "aero_mpi_4_spMV_kernel.h"
#include "aero_mpi_5_dirichlet_kernel.h"
#include "aero_mpi_6_dotPV_kernel.h"
#include "aero_mpi_7_updateUR_kernel.h"
#include "aero_mpi_8_dotR_kernel.h"
#include "aero_mpi_9_updateP_kernel.h"
#include "aero_mpi_10_update_kernel.h"
