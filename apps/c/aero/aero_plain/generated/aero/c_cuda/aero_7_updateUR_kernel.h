...
extern "C" __global__ 
void op2_k_aero_7_updateUR_wrapper(
...
const char op2_k_aero_7_updateUR_src[] = R"_op2_k(
namespace op2_m_aero_7_updateUR {
...
void op_par_loop_aero_7_updateUR(
    ...
    namespace kernel = op2_m_aero_7_updateUR;
    ...
    op_profile_enter_kernel("aero_7_updateUR", "c_CUDA", "Direct");
    op_profile_enter("Init");

    op_profile_enter("Kernel Info Setup");

    static bool first_invocation = true;
    static op::f2c::KernelInfo info("op2_k_aero_7_updateUR_wrapper",
                                    (void *)op2_k_aero_7_updateUR_wrapper,
                                    op2_k_aero_7_updateUR_src);

    auto [block_limit, block_size] = info.get_launch_config(nullptr, set->size);
    block_limit = std::min(block_limit, getBlockLimit(args, n_args, block_size, "aero_7_updateUR"));
