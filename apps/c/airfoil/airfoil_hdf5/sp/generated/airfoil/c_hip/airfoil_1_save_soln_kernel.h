...
void op2_k_airfoil_1_save_soln_wrapper(
...
const char op2_k_airfoil_1_save_soln_src[] = R"_op2_k(
namespace op2_m_airfoil_1_save_soln {
...
void op_par_loop_airfoil_1_save_soln(
    ...
    namespace kernel = op2_m_airfoil_1_save_soln;
    ...
    static op::f2c::KernelInfo info("op2_k_airfoil_1_save_soln_wrapper",
                                    (void *)op2_k_airfoil_1_save_soln_wrapper,
                                    op2_k_airfoil_1_save_soln_src);
