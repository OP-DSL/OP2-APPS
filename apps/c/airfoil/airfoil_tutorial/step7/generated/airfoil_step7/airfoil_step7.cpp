...
void op_par_loop_airfoil_step7_1_save_soln(char const *, op_set, op_arg, op_arg);

void op_par_loop_airfoil_step7_2_adt_calc(char const *, op_set, op_arg, op_arg, op_arg, op_arg, op_arg, op_arg);

void op_par_loop_airfoil_step7_3_res_calc(char const *, op_set, op_arg, op_arg, op_arg, op_arg, op_arg, op_arg, op_arg, op_arg);

void op_par_loop_airfoil_step7_4_bres_calc(char const *, op_set, op_arg, op_arg, op_arg, op_arg, op_arg, op_arg);

void op_par_loop_airfoil_step7_5_update(char const *, op_set, op_arg, op_arg, op_arg, op_arg, op_arg);
...
int main(int argc, char **argv) {
  ...
  for (int iter = 1; iter <= NUM_ITERATIONS; iter++) {
    ...
    op_par_loop_airfoil_step7_1_save_soln("save_soln", cells,
    ...
    for (int k=0; k < 2; ++k) {
      ...
      op_par_loop_airfoil_step7_2_adt_calc("adt_calc", cells,
      ...
      op_par_loop_airfoil_step7_3_res_calc("res_calc", edges,
      ...
      op_par_loop_airfoil_step7_4_bres_calc("bres_calc", bedges,
      ...
      rms = 0.0f;
      op_par_loop_airfoil_step7_5_update("update", cells,
