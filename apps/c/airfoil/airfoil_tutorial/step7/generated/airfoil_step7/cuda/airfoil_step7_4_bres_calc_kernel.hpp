...
__global__ void op_cuda_airfoil_step7_4_bres_calc(
...
void op_par_loop_airfoil_step7_4_bres_calc(
    ...
    if (OP_diags > 2)
        printf(" kernel routine (indirect): airfoil_step7_4_bres_calc\n");
    ...
    for (int round = 0; round < 2; ++round ) {
        ...
        if (end - start > 0) {
            ...
            op_cuda_airfoil_step7_4_bres_calc<<<num_blocks, block_size>>>(
                (double *)arg0.data_d,
                (double *)arg2.data_d,
                (double *)arg3.data_d,
                (double *)arg4.data_d,
